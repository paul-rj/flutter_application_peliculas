            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  const Text('Bienvenido', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Color(0xFF2d3748))),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 24),
                    _buildGradientButton('Ingresar', () async {
                      try {
              ...
              Row(
                ...
                children: [
                  Text('¿No tienes cuenta? ', style: TextStyle(color: Colors.grey[600], fontSize: 14)),
                  TextButton(
                    onPressed: () => Navigator.pushNamed(context, '/register'),
                    style: TextButton.styleFrom(padding: EdgeInsets.zero, minimumSize: Size.zero, tapTargetSize: MaterialTapTargetSize.shrinkWrap),
                    child: const Text('Regístrate', style: TextStyle(color: Color(0xFF667eea), fontSize: 14, fontWeight: FontWeight.w600)),
                  ),
                ],
              ),
            ],
